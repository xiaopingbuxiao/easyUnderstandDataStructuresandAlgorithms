...
import { HashTableLinearProbing } from '../src/javascript/data-structures/hash-table-linear-probing'
import MyObj from './my-obj';



describe('线性探查处理hash-table的冲突问题', () => {
  const A = 'Jonathan';
  const B = 'Jamie';
  const C = 'Sue';
  it('starts empty', () => {
  ...
  it('generates hashcode', () => {
    // numbers
    let hashTable = new HashTableLinearProbing();
