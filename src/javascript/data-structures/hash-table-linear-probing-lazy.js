...
export class HashTableLinearProbingLazy {
  ...
  put(key, value) {
    if (key != null && value != null) {
      ...
      if (
        this.table[position] == null // 如果当前位置没有元素 或者有元素但是已经被删除了
        ...
        while (this.table[index] != null && !this.table[index].isDeleted) { // !this.table[position].isDeleted ???? 此判断个人认为是 this.table[index].isDeleted
          index++
        }
